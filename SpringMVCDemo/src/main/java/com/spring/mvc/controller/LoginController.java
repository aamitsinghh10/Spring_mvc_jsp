...
public class LoginController {
     ...
     *
     * POST /login: sends the data as payload in the body of the request
   ...
   //@RequestMapping(path="/login", method = RequestMethod.GET)
    ...
    public String loginPage(HttpServletRequest request, Map<String,List<String>> map,
                            Map<String, String> errorMap, String error){
       //GET
        if(error!=null){
    ...
    @PostMapping("/login")
    public String loginPostPage(LoginDTO dto, HttpServletRequest request, HttpSession session,
